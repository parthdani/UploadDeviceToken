...
def get_profile_payload(ctid, identity, name, email):
...
def main():
    ...
    global PROFILE_FILE_NAME, API_PATH, CT_REGION, PROJECT_ID, PROJECT_PASSCODE

    PROFILE_FILE_NAME = input("Enter File Name : ")
    CT_REGION = input("Enter CleverTap Region : ")
    PROJECT_ID = input("Enter CleverTap Project ID : ")
    PROJECT_PASSCODE = input("Enter ClverTap Passcode : ")


    if(CT_REGION == 'us1'):
        API_PATH = "us1.api.clevertap.com"
    elif(CT_REGION == 'in1'):
        API_PATH = "in1.api.clevertap.com"
    elif(CT_REGION == 'sg1'):
        API_PATH = "sg1.api.clevertap.com"
    elif(CT_REGION == 'eu1'):
